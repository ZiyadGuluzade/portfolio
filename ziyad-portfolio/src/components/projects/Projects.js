        ...
        return(
            <React.Fragment>
                <section id='projects' className='container-fluid'>
                    ...
                    <div className='block'>
                        <Card name='Book Project' button1='Project' button2='Github' src={require('../../images/projects/book-pages.jpg')} />
                        <Card name='Jeopardy Game' button1='Project' button2='Github' src={require('../../images/projects/jeopardy-game.jpeg')}/>
                        <Card name='Rocks' button1='Project' button2='Github' src={require('../../images/projects/amatista.jpg')}/>
                    </div>
                </section>
            </React.Fragment>
        )
